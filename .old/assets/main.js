							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Piliere',
										'page_location': 'https://putovnykruh.cz/#piliere',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Terminy',
										'page_location': 'https://putovnykruh.cz/#terminy',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Minule',
										'page_location': 'https://putovnykruh.cz/#minule',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Buduce',
										'page_location': 'https://putovnykruh.cz/#buduce',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Home',
										'page_location': 'https://putovnykruh.cz',
									});
								},
							],
						},
